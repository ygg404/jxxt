...
public class CheckQualityDTO extends BasicDTO {
    ...
    private CheckQuality checkQuality;
    private QualityScore qualityScore;
    private List<QualityScore> scoreList;

    public CheckQuality getCheckQuality() {
        return checkQuality;
    }

    public void setCheckQuality(CheckQuality checkQuality) {
    ...
    public List<QualityScore> getScoreList() {
        return scoreList;
    }

    public void setScoreList(List<QualityScore> scoreList) {
